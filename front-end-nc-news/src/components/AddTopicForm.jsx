...
class AddTopicForm extends Component {
  ...
  handleChangeTopic(event) {
    this.setState({
      newTopic: {
        ...
        description: this.state.newTopic.description
      }
    });
  }
  ...
  handleFormSubmit(event) {
    ...
    Promise.resolve(postTopic(slug, description)).then(result => {
      if (result) {
          ...
          <Form className="FormInput" onSubmit={this.handleFormSubmit}>
            ...
            <Form.Group controlId="formTopicDescription">
              <Form.Control
                className="text-area-input"
                type="input"
                placeholder="Enter a brief description of your topic here..."
